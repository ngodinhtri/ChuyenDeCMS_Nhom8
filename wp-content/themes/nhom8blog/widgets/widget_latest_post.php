<?php
    // Tạo Class nhom8blog_latest_post
    class nhom8blog_latest_post extends WP_Widget {
     
        function __construct() {
            parent::__construct(
             
            // Thông tin ID widget
            'nhom8blog_latest_post', 
             
            // Tên widget
            __('Bài viết mới nhất', 'nhom8blog'), 
             
            // Mô tả widget
            array( 'description' => __( 'Đây là widget show bài viết mới nhất', 'nhom8blog' ), ) 
            );
        }
